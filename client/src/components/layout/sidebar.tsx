    ...
    <>
      ...
      >
        <div className="flex flex-col h-full">
          <div className="flex items-center justify-between px-6 py-2 border-b border-gray-100 overflow-hidden">
            <Link
              href="/dashboard"
            ...
            >
              <img
                src={logo3}
                alt="Logo"
                className="h-32 w-full object-contain -my-6"
              />
              <span className="text-[10px] text-center font-medium text-gray-400 px-2 line-clamp-1">
